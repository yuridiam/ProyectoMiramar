        ...
        <div id="page-wrapper">
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="">
                        <a href="dashboardempleado.html" class="logo">
                    ...
                    <div class="scrollbar-wrapper">
                        <div>
                            ...
                            <ul class="metisMenu nav" id="side-menu">
                                <li><a href="dashboardempleado.html"><i class="ti-home"></i> Dashboard </a></li>

                                <li><a href="nuevaventa.html"><span class="label label-custom pull-right">1</span> <i class="mdi mdi-square-inc-cash"></i> Nueva Venta </a></li>
